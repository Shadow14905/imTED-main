...
data_root = '/home/stud/lyh/projects/imted/datasets/COCO/'
pretrained = '/home/stud/lyh/projects/imted/assets/mae_pretrain_vit_base_full.pth'
...
data = dict(
    ...
    train=dict(
        ...
        img_prefix=data_root + 'trainval2014/',
        ann_file='/home/stud/lyh/projects/imted/datasets/cocosplit/datasplit/trainvalno5k.json'),
    val=dict(
        classes = classes,
        # img_prefix=data_root + 'val2017/',
        img_prefix=data_root + 'trainval2014/',
        ann_file='/home/stud/lyh/projects/imted/datasets/cocosplit/datasplit/5k.json'),
    test=dict(
        classes = classes,
        # img_prefix=data_root + 'val2017/',
        img_prefix=data_root + 'trainval2014/',
